...
namespace StateMachine
{
	...
	/// </summary>
	public abstract partial class Condition : Node, IStateComponent
	{
		private bool _isCached = false;
		private bool _cachedStatement = default;
		internal StateConditionRES _originRES;

		/// <summary>
		/// Use this property to access shared data from the <see cref="StateConditionRES"/> that corresponds to this <see cref="Condition"/>
		/// </summary>
		protected StateConditionRES OriginRES => _originRES;
	...
	public readonly struct StateCondition
	{
		...
		/// <summary>
		/// Constructor of StateCondition structure
		/// </summary>
